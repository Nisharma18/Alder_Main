...
console.log(data);
  ...
  const handlesubmit = (e) => {
    ...
    if (!inputs.partytype) {
      toast.error("Party type is required", { autoClose: 1000 });
      return;
    }
    ...
    // if (suppliervendor[0].billContactperson.trim() === "") {
    //   toast.error("Contact person is required", { autoClose: 1000 });
    //   window.scrollTo(0, 0);
    //   return;
    // }
    // if (suppliervendor[0].billAddress1.trim() === "") {
    //   toast.error("Address 1 is required", { autoClose: 1000 });
    //   window.scrollTo(0, 0);
    //   return;
    // }
...
console.log(suppliervendor[0]);
  ...
  return (
    <div className="page-content" style={{ overflow: "hidden" }}>
      <Container fluid>
        <BreadCrumb pageName="Ledger Create" title="Master" subTitle="Ledger Create" />
        <Row>
          <Col lg={12}>
